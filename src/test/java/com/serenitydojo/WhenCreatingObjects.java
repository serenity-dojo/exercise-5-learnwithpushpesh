...
public class WhenCreatingObjects {
    ...
    @Test
    public void create_a_hampster() {
        Hampster hery = new Hampster("Hery", "Running", 1);
        Assert.assertEquals("Hery", hery.getName());
        Assert.assertEquals(1, hery.getAge());
        Assert.assertEquals("Running", hery.getFavouritGame());
    }
}
